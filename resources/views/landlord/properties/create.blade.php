    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                <h1 class="text-2xl font-bold text-gray-800 mb-6">Add New Property</h1>
                ...
                <form action="{{ route('landlord.properties.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title') }}" required
                                    ...
                                    placeholder="e.g., Modern 2BR Apartment in Divisoria">
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="address" id="address" value="{{ old('address') }}" required
                                    class="w-full border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500"
                                    placeholder="e.g., 123 Corrales Ave., Divisoria, Cagayan de Oro City">
                            </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="deposit" id="deposit" value="{{ old('deposit') }}" min="0" step="0.01"
                                    class="w-full border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500"
                                    placeholder="0.00">
                            </div>
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div>
                                ...
                                <input type="number" name="bedrooms" id="bedrooms" value="{{ old('bedrooms', 0) }}" min="0"
                                    class="w-full border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500">
                            </div>

                            <div>
                                <label for="bathrooms" class="block text-sm font-medium text-gray-700 mb-1">Bathrooms</label>
                                <input type="number" name="bathrooms" id="bathrooms" value="{{ old('bathrooms', 0) }}" min="0"
                                    class="w-full border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500">
                            </div>

                            <div>
                                <label for="floor_area" class="block text-sm font-medium text-gray-700 mb-1">Floor Area (sqm)</label>
                                <input type="number" name="floor_area" id="floor_area" value="{{ old('floor_area') }}" min="0" step="0.01"
                                    class="w-full border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500">
                            </div>

                            <div>
                                <label for="max_occupants" class="block text-sm font-medium text-gray-700 mb-1">Max Occupants</label>
                                <input type="number" name="max_occupants" id="max_occupants" value="{{ old('max_occupants') }}" min="1"
                                    class="w-full border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="minimum_stay" id="minimum_stay"
                                    class="w-full border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500">
                                    <option value="1 month" {{ old('minimum_stay') == '1 month' ? 'selected' : '' }}>1 Month</option>
                                    <option value="3 months" {{ old('minimum_stay') == '3 months' ? 'selected' : '' }}>3 Months</option>
                                    <option value="6 months" {{ old('minimum_stay') == '6 months' ? 'selected' : '' }}>6 Months</option>
                                    <option value="1 year" {{ old('minimum_stay') == '1 year' ? 'selected' : '' }}>1 Year</option>
                                </select>
                            </div>
                    ...
                    <!-- Images -->
                    <div class="mb-8">
                        <h2 class="text-lg font-semibold text-gray-700 mb-4 pb-2 border-b">Property Images</h2>
