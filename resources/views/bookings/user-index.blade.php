@extends('layouts.mobi        @foreach ($bookings as $booking)
          <div class="property-card">
            <div class="p-4">)

@section('title', 'My Bookings - Homygo')

@section('home-route', route('renter.dashboard'))

@section('content')
      <!-- Header Section -->
      <div class="text-center py-4">
        <h1 class="text-2xl font-bold text-gray-800 mb-2">My Bookings</h1>
        <p class="text-gray-600">Track your rental bookings</p>
      </div>
      ...
      @else
        ...
        <div class="empty-state">
          ...
          <p class="text-gray-500 mb-6">Start exploring properties to make your first booking.</p>
