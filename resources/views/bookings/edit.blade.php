...
@section('title', 'Edit Booking - Homygo')
...
@section('content')
  ...
  <div class="text-center py-4">
    ...
    <p class="text-gray-600">Modify your reservation details</p>
  </div>
  ...
  <div class="property-card">
    ...
    <div class="p-4">
      ...
      <div class="text-xl font-bold text-green-600">₱{{ number_format($booking->property->price_per_night) }}<span class="text-sm font-normal text-gray-600">/night</span></div>
    </div>
  </div>

  <!-- Booking Form -->
  <div class="dashboard-card">
    <h3 class="text-lg font-semibold text-gray-800 mb-4">Update Booking Details</h3>
    ...
    <form method="POST" action="{{ route('bookings.update', $booking) }}" class="space-y-4">
      ...
      <div>
        ...
        <textarea id="special_requests" 
                  ...
                  class="form-textarea">{{ old('special_requests', $booking->special_requests) }}</textarea>
      </div>

      <!-- Price Calculation -->
      <div class="bg-gray-50 rounded-lg p-4 mt-6">
        <h4 class="font-semibold text-gray-800 mb-2">Updated Price Breakdown</h4>
        <div class="space-y-1 text-sm">
          ...
          <div class="flex justify-between">
            ...
            <span id="nights-count">{{ $booking->start_date->diffInDays($booking->end_date) }}</span>
          </div>
          <div class="border-t pt-2 mt-2">
            <div class="flex justify-between font-semibold">
              <span>Total:</span>
              <span id="total-price">₱{{ number_format($booking->total_price) }}</span>
            </div>
          </div>
        </div>
      </div>
